...
// Shared semantic badge classes for moderation actions.
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          <Card className={`border-border/40 bg-card/40 ${selected ? "lg:col-span-2" : "lg:col-span-3"}`}>
            <CardContent className="p-0">
              {isLoading ? (
                <LoadingFallback text="Loading cases…" variant="inline" />
              ) : entries.length === 0 ? (
            ...
            <Card className="border-border/40 bg-card/40 lg:col-span-1 h-fit">
              ...
              <CardContent className="space-y-3 text-xs">
                <div>
                  ...
                  <Badge variant="outline" className={actionBadgeClass(selected.action)}>{selected.action}</Badge>
                </div>
                <div>
